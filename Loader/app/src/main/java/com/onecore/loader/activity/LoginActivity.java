...
public class LoginActivity extends AppCompatActivity {
    ...
    private static void Login(LoginActivity activity, String key) {
        com.onecore.loader.utils.DiagnosticLogger.log("Login request started keyLength=" + (key == null ? 0 : key.length()));
        Handler responseHandler = new Handler(Looper.getMainLooper()) {
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 0) {
                    com.onecore.loader.utils.DiagnosticLogger.log("Login authorized; opening MainActivity");
                    ...
                    com.onecore.loader.utils.DiagnosticLogger.log("Login denied: " + error);
        ...
        new Thread(() -> {
            ...
            try {
                ...
                com.onecore.loader.utils.DiagnosticLogger.log("Login native response=" + result);
                if ("OK".equals(result)) {
                    msg.what = 0;
                } else {
                    msg.what = 1;
                ...
                com.onecore.loader.utils.DiagnosticLogger.exception("Login native Check failed", t);
                msg.what = 1;
